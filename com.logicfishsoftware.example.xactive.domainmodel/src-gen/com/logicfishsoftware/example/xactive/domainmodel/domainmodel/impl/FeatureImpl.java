 ...
 * <ul>
 *   <li>{@link com.logicfishsoftware.example.xactive.domainmodel.domainmodel.impl.FeatureImpl#getAnnotations <em>Annotations</em>}</li>
 *   <li>{@link com.logicfishsoftware.example.xactive.domainmodel.domainmodel.impl.FeatureImpl#getName <em>Name</em>}</li>
 *   <li>{@link com.logicfishsoftware.example.xactive.domainmodel.domainmodel.impl.FeatureImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FeatureImpl extends MinimalEObjectImpl.Container implements Feature
{
  ...
  public EList<XAnnotation> getAnnotations()
  {
    if (annotations == null)
    {
      annotations = new EObjectContainmentEList<XAnnotation>(XAnnotation.class, this, DomainmodelPackage.FEATURE__ANNOTATIONS);
    }
    return annotations;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case DomainmodelPackage.FEATURE__ANNOTATIONS:
