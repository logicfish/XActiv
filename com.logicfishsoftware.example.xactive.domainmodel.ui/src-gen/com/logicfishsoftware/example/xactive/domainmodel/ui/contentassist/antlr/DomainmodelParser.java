...
* generated by Xtext
*/
package com.logicfishsoftware.example.xactive.domainmodel.ui.contentassist.antlr;
...
public class DomainmodelParser extends AbstractContentAssistParser {
	...
	@Override
	protected com.logicfishsoftware.example.xactive.domainmodel.ui.contentassist.antlr.internal.InternalDomainmodelParser createParser() {
		com.logicfishsoftware.example.xactive.domainmodel.ui.contentassist.antlr.internal.InternalDomainmodelParser result = new com.logicfishsoftware.example.xactive.domainmodel.ui.contentassist.antlr.internal.InternalDomainmodelParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getEntityAccess().getGroup_4_2(), "rule__Entity__Group_4_2__0");
					...
					put(grammarAccess.getEntityAccess().getTypeParametersAssignment_4_1(), "rule__Entity__TypeParametersAssignment_4_1");
					put(grammarAccess.getEntityAccess().getTypeParametersAssignment_4_2_1(), "rule__Entity__TypeParametersAssignment_4_2_1");
					...
					put(grammarAccess.getOperationAccess().getTypeParametersAssignment_2_1(), "rule__Operation__TypeParametersAssignment_2_1");
					put(grammarAccess.getOperationAccess().getTypeParametersAssignment_2_2_1(), "rule__Operation__TypeParametersAssignment_2_2_1");
					...
					put(grammarAccess.getOperationAccess().getTypeAssignment_7_1(), "rule__Operation__TypeAssignment_7_1");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			com.logicfishsoftware.example.xactive.domainmodel.ui.contentassist.antlr.internal.InternalDomainmodelParser typedParser = (com.logicfishsoftware.example.xactive.domainmodel.ui.contentassist.antlr.internal.InternalDomainmodelParser) parser;
