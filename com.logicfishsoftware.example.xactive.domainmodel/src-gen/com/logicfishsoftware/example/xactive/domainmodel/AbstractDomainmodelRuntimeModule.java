...
/**
 * Manual modifications go to {com.logicfishsoftware.example.xactive.domainmodel.DomainmodelRuntimeModule}
 */
...
public abstract class AbstractDomainmodelRuntimeModule extends DefaultRuntimeModule {
	...
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "com/logicfishsoftware/example/xactive/domainmodel/Domainmodel.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("com.logicfishsoftware.example.xactive.domainmodel.Domainmodel");
	}
	
	public void configureFileExtensions(Binder binder) {
		if (properties == null || properties.getProperty(Constants.FILE_EXTENSIONS) == null)
			binder.bind(String.class).annotatedWith(Names.named(Constants.FILE_EXTENSIONS)).toInstance("admodel");
	}
	
	// contributed by org.eclipse.xtext.generator.grammarAccess.GrammarAccessFragment
	public Class<? extends org.eclipse.xtext.IGrammarAccess> bindIGrammarAccess() {
		return com.logicfishsoftware.example.xactive.domainmodel.services.DomainmodelGrammarAccess.class;
	}

	// contributed by org.eclipse.xtext.generator.serializer.SerializerFragment
	public Class<? extends org.eclipse.xtext.serializer.sequencer.ISemanticSequencer> bindISemanticSequencer() {
		return com.logicfishsoftware.example.xactive.domainmodel.serializer.DomainmodelSemanticSequencer.class;
	}

	// contributed by org.eclipse.xtext.generator.serializer.SerializerFragment
	public Class<? extends org.eclipse.xtext.serializer.sequencer.ISyntacticSequencer> bindISyntacticSequencer() {
		return com.logicfishsoftware.example.xactive.domainmodel.serializer.DomainmodelSyntacticSequencer.class;
	}
	...
	public Class<? extends org.eclipse.xtext.parser.IParser> bindIParser() {
		return com.logicfishsoftware.example.xactive.domainmodel.parser.antlr.DomainmodelParser.class;
	}
	...
	public Class<? extends org.eclipse.xtext.parser.antlr.IAntlrTokenFileProvider> bindIAntlrTokenFileProvider() {
		return com.logicfishsoftware.example.xactive.domainmodel.parser.antlr.DomainmodelAntlrTokenFileProvider.class;
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public Class<? extends org.eclipse.xtext.parser.antlr.Lexer> bindLexer() {
		return com.logicfishsoftware.example.xactive.domainmodel.parser.antlr.internal.InternalDomainmodelLexer.class;
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public com.google.inject.Provider<com.logicfishsoftware.example.xactive.domainmodel.parser.antlr.internal.InternalDomainmodelLexer> provideInternalDomainmodelLexer() {
		return org.eclipse.xtext.parser.antlr.LexerProvider.create(com.logicfishsoftware.example.xactive.domainmodel.parser.antlr.internal.InternalDomainmodelLexer.class);
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public void configureRuntimeLexer(com.google.inject.Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class).annotatedWith(com.google.inject.name.Names.named(org.eclipse.xtext.parser.antlr.LexerBindings.RUNTIME)).to(com.logicfishsoftware.example.xactive.domainmodel.parser.antlr.internal.InternalDomainmodelLexer.class);
	}
	...
	@org.eclipse.xtext.service.SingletonBinding(eager=true)	public Class<? extends com.logicfishsoftware.example.xactive.domainmodel.validation.DomainmodelJavaValidator> bindDomainmodelJavaValidator() {
		return com.logicfishsoftware.example.xactive.domainmodel.validation.DomainmodelJavaValidator.class;
	}
	...
	public Class<? extends org.eclipse.xtext.formatting.IFormatter> bindIFormatter() {
		return com.logicfishsoftware.example.xactive.domainmodel.formatting.DomainmodelFormatter.class;
	}
	...
	public Class<? extends org.eclipse.xtext.xbase.jvmmodel.IJvmModelInferrer> bindIJvmModelInferrer() {
		return com.logicfishsoftware.example.xactive.domainmodel.jvmmodel.DomainmodelJvmModelInferrer.class;
	}

	// contributed by com.logicfishsoftware.xtend.xactive.generator.XActiveGeneratorFragment
	public Class<? extends com.logicfishsoftware.xtend.xactive.XActiveCompiler> bindXActiveCompiler() {
		return com.logicfishsoftware.xtend.xactive.XActiveCompilerImpl.class;
	}

	// contributed by com.logicfishsoftware.xtend.xactive.generator.XActiveGeneratorFragment
	public void configureRuntimeInjectorProvider(com.google.inject.Binder binder) {
		binder.bind(
	com.logicfishsoftware.commons.emf.RuntimeInjectorProvider.class
).annotatedWith(
	com.google.inject.name.Names.named("com.logicfishsoftware.xtend.xactive")
).to(
	com.logicfishsoftware.example.xactive.domainmodel.xactive.DomainmodelInjectorProviderDefault.getDefaultProvider()
) ;
	}
