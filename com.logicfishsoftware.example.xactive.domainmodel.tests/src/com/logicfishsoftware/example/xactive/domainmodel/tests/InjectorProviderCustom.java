...
import com.logicfishsoftware.example.xactive.domainmodel.DomainmodelRuntimeModule;
import com.logicfishsoftware.example.xactive.domainmodel.DomainmodelStandaloneSetup;
import com.logicfishsoftware.example.xactive.domainmodel.tests.annotations.ExportedClass;
import com.logicfishsoftware.example.xactive.domainmodel.tests.annotations.SynchronizeTestXProcessor;
	...
	public static class TestClassPathAssembler extends
		...
		public void assembleCompilerClassPath(OnTheFlyJavaCompiler compiler) {
			...
			if (compiler instanceof EclipseRuntimeDependentJavaCompiler) {
				...
				compiler.addClassPathOfClass(JvmType.class);
				compiler.addClassPathOfClass(MutableTypeDeclaration.class);
				compiler.addClassPathOfClass(XActive.class);
				compiler.addClassPathOfClass(ExportedClass.class);
			}
		}
	}
}
